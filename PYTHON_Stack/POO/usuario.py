...
usuario1.balance()
usuario1.deposit(5000)
usuario1.deposit(10000)
usuario1.deposit(15000)
usuario1.withdraw(5000)
usuario1.balance()

#Operaciones Usuario 2
usuario2.deposit(5000)
usuario2.deposit(10000)
usuario2.withdraw(5000)
usuario2.withdraw(150000)
usuario2.balance()

#Operaciones Usuario 3
usuario3.deposit(500000)
usuario3.withdraw(10000)
usuario3.withdraw(5000)
usuario3.withdraw(150000)
usuario3.balance()
